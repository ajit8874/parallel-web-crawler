...
public final class WebCrawlerMain {
  ...
  private void run() throws Exception {
    ...
    while (config.getResultPath().isBlank() !=true || config.getResultPath().isEmpty() !=true){
      System.out.println("Crawler Result: " + config.getResultPath());
...
//    }
    ...
    while (!config.getProfileOutputPath().isBlank() || config.getProfileOutputPath().isEmpty()){
